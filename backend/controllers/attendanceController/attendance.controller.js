    ...
    try {
        ...
        const analysis = employees.map((employee) => {
            ...
            employeeAttendance.forEach((record) => {
                ...
                stats.totalAttendance.push(record)
                switch (record.status) {
                    case "Present":
                        stats.totalPresent++;
                        stats.totalPresentData.push(record)
                        break;
                    case "Absent":
                        stats.totalAbsent++;
                        stats.totalAbsentData.push(record)
                        break;
                    case "Half-Day":
                        stats.totalHalfDay++;
                        stats.totalHalfDayData.push(record)
                        break;
                    case "Leave":
                        stats.totalLeave++;
                        stats.totalLeaveData.push(record)
                        break;
                    case "Remote":
                        stats.totalRemote++;
                        stats.totalRemoteData.push(record)
                        break;
                    case "Holiday":
                        stats.totalHoliday++;
                        stats.totalHolidayData.push(record)
                        break;
                }
            });
