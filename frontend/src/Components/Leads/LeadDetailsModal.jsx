        ...
        <div className="p-4">
          ...
          <div className="mb-6">
            ...
            <div className="bg-gray-50 p-3 rounded-lg">
              <div className="mb-2">
                <span className="font-semibold">Name:</span> {lead.contact?.name}
              </div>
              <div className="flex items-center gap-2 mb-2">
                <Phone size={16} />
                <span className="font-semibold">Phone:</span> {lead.contact?.phoneNo}
              </div>
              {lead.contact?.email && (
                <div className="flex items-center gap-2">
                  <Mail size={16} />
                  <span className="font-semibold">Email:</span> {lead.contact?.email}
                </div>
              )}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div>
              <h3 className="text-md font-medium mb-2">Lead For</h3>
              <div className="bg-gray-50 p-3 rounded-lg">
                {lead.for?.name}
              </div>
            </div>
          ...
          {lead.reference && (
            <div className="mb-6">
              ...
              <div className="bg-gray-50 p-3 rounded-lg">
                {lead.reference.name && (
                  <div className="mb-2">
                    <span className="font-semibold">Name:</span> {lead.reference.name}
                  </div>
                )}
                {lead.reference.phoneNo && (
                  <div className="flex items-center gap-2 mb-2">
                    <Phone size={16} />
                    <span className="font-semibold">Phone:</span> {lead.reference.phoneNo}
                  </div>
                )}
                {lead.reference.email && (
                  <div className="flex items-center gap-2">
                    <Mail size={16} />
                    <span className="font-semibold">Email:</span> {lead.reference.email}
                  </div>
                )}
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            ...
            <div>
              ...
              <div className="bg-gray-50 p-3 rounded-lg">
                <div className="flex items-center gap-2">
                  <User size={16} />
                  <span>Assigned to: {lead?.assignedTo?.user?.name || "Not assigned"}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mb-4">
            ...
            {showFollowUpForm && (
              <form onSubmit={handleSubmitFollowUp} className="mb-4 bg-gray-50 p-3 rounded-lg">
                <textarea
                  value={conclusion}
                  ...
                  <div key={followUp._id} className="bg-gray-50 p-3 rounded-lg">
                    <div className="flex justify-between items-center mb-1">
                      <div className="flex items-center gap-2 text-sm">
                        ...
                        <span className="font-medium">Follow-up #{followUp.sequence}</span>
                      </div>
